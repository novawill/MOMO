...
- (void)customNavigationItemMethodsImage:(NSString *)image target:(id)target selector:(SEL)action isLeft:(BOOL)isleft
{
    ...
    if (isleft) {
        ...
        self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:image]
                                                                                 style:UIBarButtonItemStylePlain
                                                                                target:target
                                                                                action:action];
    ...
    {
        self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:image]
                                                                                  style:UIBarButtonItemStylePlain
                                                                                 target:target
                                                                                 action:action];
    }
...
- (void)customNavigationItemWithLeftImage:(NSString *)leftImage RightImage:(NSString *)rightImage isShowRight:(BOOL)show
{
    ...
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:leftImage]
                                                                             style:UIBarButtonItemStylePlain
                                                                            target:self
                                                                            action:@selector(presentLeftMenuViewController:)];
    ...
    if (show) {
        ...
        self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:rightImage]
                                                                                  style:UIBarButtonItemStylePlain
                                                                                 target:self
                                                                                 action:@selector(presentRightMenuViewController:)];
    }
